...
var BASE_URL_DECODE = 'http://zxing.org/w/decode?u=';

var BASE_URL_GENERATE = 'https://chart.googleapis.com/chart?cht=qr&chs=300x300&chl='

function generate(generateData) {
	return BASE_URL_GENERATE + encodeURIComponent(generateData);
}
...
function decode (imageURL, callback){
	...
	request(BASE_URL_DECODE + encodeURIComponent(imageURL), function (err, resp, body) {
